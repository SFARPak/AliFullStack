...
export function registerSupabaseHandlers() {
  ...
  // Set app project - links a AliFullStack app to a Supabase project
  handle(
  ...
  // Unset app project - removes the link between a AliFullStack app and a Supabase project
  ...
  testOnlyHandle(
    ...
    async (
      ...
      safeSend(event.sender, "deep-link-received", {
        ...
        url: "https://supabase-oauth.alifullstack.alitech.io/api/connect-supabase/login",
      });
      logger.info(
