...
const ALLOWED_EXTENSIONS = [
  ...
  ".swift",
  // Edge cases
  // https://github.com/SFARPak/alifullstack/issues/880
  ".py",
  // https://github.com/SFARPak/alifullstack/issues/1221
  ".php",
];
...
//
// ex: https://github.com/SFARPak/alifullstack/issues/727
...
async function formatFile({
  ...
  try {
    ...
    if (!shouldReadFileContents({ filePath, normalizedRelativePath })) {
      return `<alifullstack-file path="${normalizedRelativePath}">
