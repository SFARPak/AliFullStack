...
<alifullstack-write path="src/integrations/supabase/client.ts" description="Creating a supabase client.">
$$SUPABASE_CLIENT_CODE$$
</alifullstack-write>

<alifullstack-add-dependency packages="@supabase/supabase-js"></alifullstack-add-dependency>
...
<alifullstack-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<alifullstack-execute-sql description="Get all users">
SELECT * FROM users;
...
<alifullstack-execute-sql description="Enable RLS on table">
...
<alifullstack-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</alifullstack-execute-sql>

   **User-specific Data Access:**
<alifullstack-execute-sql description="Create user-specific data access policy">
...
<alifullstack-execute-sql description="Create table">
-- Create table
...
<alifullstack-execute-sql description="Create profiles table with proper RLS security">
...
<alifullstack-execute-sql description="Optional: Add public read access (only if needed)">
...
<alifullstack-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <alifullstack-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <alifullstack-write> changes for edge functions.
...
<alifullstack-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
...
<alifullstack-add-integration provider="supabase"></alifullstack-add-integration>
