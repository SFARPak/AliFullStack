...
export async function createApp(
  page: Page,
  appName: string,
  options: { isFullStack: boolean; selectedBackendFramework: string },
): Promise<number> {
  ...
  await page
    .getByRole("textbox", { name: "Ask AliFullStack to build..." })
    .fill(prompt);
...
export async function createBackendFile(
  page: Page,
  appId: number,
  filePath: string,
  content: string,
...
export async function createFrontendFile(
  page: Page,
  appId: number,
  filePath: string,
  content: string,
